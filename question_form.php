...
$question= $wpdb->get_row($wpdb->prepare("SELECT question, explanation FROM wp_quiz_question WHERE ID=%d", $_REQUEST['question']));
$all_answers = $wpdb->get_results($wpdb->prepare("SELECT answer,correct FROM wp_quiz_answer WHERE question_id=%d ORDER BY sort_order", $_REQUEST['question']));
...
<a href="edit.php?page=quizzin/question.php&amp;quiz=<?php echo $_REQUEST['quiz']?>"><?php e("Go to Questions Page") ?></a>
</div>
</form>
